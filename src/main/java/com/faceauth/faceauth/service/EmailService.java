...
public class EmailService {
    ...
    // Sent on a plain background thread — this does NOT depend on Spring's
    // @Async/@EnableAsync machinery, so it can never silently fall back to
    // running on (and blocking) the calling request thread.
